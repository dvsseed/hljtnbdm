        ...
        <div class="col-md-12">
            ...
            <form id="caseform" action="{{ route('case.store') }}" method="POST" role="form" data-toggle="validator">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="cl_case_date" id="cl_case_date" class="input-sm datepicker" size="7" data-date-format="yyyy-mm-dd" data-date-autoclose="true" data-date-clear-btn="true" data-date-today-highlight="true" data-date-today-btn="linked" data-date-language="zh-TW" value="{{ $today }}">
                ...
                <table class="table table-bordered bg-warning" id="caseis1409" style="display: none">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clfootchkright">
                                <input type="checkbox" name="cl_foot_chk_right0" id="cl_foot_chk_right0" value="1" tabindex="9">正常
                                <input type="checkbox" name="cl_foot_chk_right1" id="cl_foot_chk_right1" value="1" tabindex="9">震动
                                <input type="checkbox" name="cl_foot_chk_right2" id="cl_foot_chk_right2" value="1" tabindex="9">针刺
                                <input type="checkbox" name="cl_foot_chk_right3" id="cl_foot_chk_right3" value="1" tabindex="9">脉搏
                                <input type="checkbox" name="cl_foot_chk_right4" id="cl_foot_chk_right4" value="1" tabindex="9">绕道
                                <input type="checkbox" name="cl_foot_chk_right5" id="cl_foot_chk_right5" value="1" tabindex="9">未检查
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clfootchkleft">
                                <input type="checkbox" name="cl_foot_chk_left0" id="cl_foot_chk_left0" value="1" tabindex="10">正常
                                <input type="checkbox" name="cl_foot_chk_left1" id="cl_foot_chk_left1" value="1" tabindex="10">震动
                                <input type="checkbox" name="cl_foot_chk_left2" id="cl_foot_chk_left2" value="1" tabindex="10">针刺
                                <input type="checkbox" name="cl_foot_chk_left3" id="cl_foot_chk_left3" value="1" tabindex="10">脉搏
                                <input type="checkbox" name="cl_foot_chk_left4" id="cl_foot_chk_left4" value="1" tabindex="10">绕道
                                <input type="checkbox" name="cl_foot_chk_left5" id="cl_foot_chk_left5" value="1" tabindex="10">未检查
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clulcers">
                                <input type="checkbox" name="cl_ulcers" id="cl_ulcers" value="1" tabindex="11">无&nbsp;
                                ...
                                慢性期(<input type="checkbox" name="cl_ulcers_slow_right" id="cl_ulcers_slow_right" value="1" tabindex="11">右/<input type="checkbox" name="cl_ulcers_slow_left" id="cl_ulcers_slow_left" value="1" tabindex="11">左)
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td rowspan="2">
                            <div class="form-group has-feedback" id="clcomplications">
                                <input type="checkbox" name="cl_complications0" id="cl_complications0" value="1" tabindex="12">无　　肾病变: stage
                                <input type="radio" name="cl_complications_stage" id="cl_complications_stage1" value="1" tabindex="12">1
                                <input type="radio" name="cl_complications_stage" id="cl_complications_stage2" value="2" tabindex="12">2
                                <input type="radio" name="cl_complications_stage" id="cl_complications_stage3" value="3" tabindex="12">3a
                                <input type="radio" name="cl_complications_stage" id="cl_complications_stage4" value="4" tabindex="12">3b
                                <input type="radio" name="cl_complications_stage" id="cl_complications_stage5" value="5" tabindex="12">4
                                <input type="radio" name="cl_complications_stage" id="cl_complications_stage6" value="6" tabindex="12">5<br>
                        　　　　<input type="checkbox" name="cl_complications1" id="cl_complications1" value="1" tabindex="12">神经病变
                                <input type="checkbox" name="cl_complications2" id="cl_complications2" value="1" tabindex="12">周边血管病变
                                其他<input type="text" id="cl_complications_other" name="cl_complications_other" size=10 tabindex="12" value="{{ old('cl_complications_other') }}">
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_waist" name="cl_waist" size="5" tabindex="6" title="20~200" pattern="^[0-9]{1,}$" maxlength="3" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_waist') }}"> cm/
                                <input type="text" id="cl_hips" name="cl_hips" size="5" tabindex="6" title="20~200" pattern="^[0-9]{1,}$" maxlength="3" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_hips') }}"> cm
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clintermittentpain">
                                <input type="checkbox" name="cl_intermittentpain" id="cl_intermittentpain" value="1" tabindex="13">无　　有
                    ...
                    <tr>
                        ...
                        <td rowspan="2">
                            <div class="form-group has-feedback">
                                <input type="radio" name="cl_blood_mne" id="cl_blood_mne" value="0" tabindex="7" checked>早<input type="radio" name="cl_blood_mne" id="cl_blood_mne" value="1" tabindex="7" required>中<input type="radio" name="cl_blood_mne" id="cl_blood_mne" value="2" tabindex="7">晚&nbsp;
                                <input type="radio" name="cl_blood_ap" id="cl_blood_ap" value="0" tabindex="7" checked>前<input type="radio" name="cl_blood_ap" id="cl_blood_ap" value="1" tabindex="7">后<br>
                                <input type="text" id="cl_blood_acpc" name="cl_blood_acpc" size="5" tabindex="7" title="10~999" pattern="^[0-9]{1,}$" maxlength="3" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_blood_acpc') }}" required> mg/dL
                                <input type="text" id="cl_blood_mins" name="cl_blood_mins" size="5" tabindex="7" disabled> 分
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group" id="clabi">
                                <input type="checkbox" name="cl_abi" id="cl_abi" value="1" tabindex="14">正常　异常
                                <input type="checkbox" name="cl_abi_right" id="cl_abi_right" value="1" tabindex="14">右
                                <input type="text" id="cl_abi_right_value" name="cl_abi_right_value" size=4 tabindex="14" value="{{ old('cl_abi_right_value') }}">
                                <input type="checkbox" name="cl_abi_left" id="cl_abi_left" value="1" tabindex="14">左
                                <input type="text" id="cl_abi_left_value" name="cl_abi_left_value" size=4 tabindex="14" value="{{ old('cl_abi_left_value') }}">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-group" id="clcavi">
                                <input type="checkbox" name="cl_cavi" id="cl_cavi" value="1" tabindex="15">正常　异常
                                <input type="checkbox" name="cl_cavi_right" id="cl_cavi_right" value="1" tabindex="15">右
                                <input type="text" id="cl_cavi_right_value" name="cl_cavi_right_value" size="4" tabindex="15" value="{{ old('cl_cavi_right_value') }}">
                                <input type="checkbox" name="cl_cavi_left" id="cl_cavi_left" value="1" tabindex="15">左
                                <input type="text" id="cl_cavi_left_value" name="cl_cavi_left_value" size="4" tabindex="15" value="{{ old('cl_cavi_left_value') }}">　R-Kcavi
                                <input type="text" id="cl_cavi_rkcavi" name="cl_cavi_rkcavi" size="4" tabindex="15" value="{{ old('cl_cavi_rkcavi') }}">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_blood_hba1c" name="cl_blood_hba1c" size="5" tabindex="8" title="3~25" pattern="^[0-9]{1,}$" maxlength="2" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_blood_hba1c') }}" required> %
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="cleyechk8">
                                <input type="checkbox" name="cl_eye_chk8" id="cl_eye_chk8" value="1" tabindex="16">正常　异常
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_cholesterol" name="cl_cholesterol" size="5" tabindex="28" title="50~300" pattern="^[0-9]{1,}$" maxlength="3" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_cholesterol') }}"> mg/dL
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clcataract">
                                <input type="checkbox" name="cl_cataract" id="cl_cataract" value="1" tabindex="17">无　　有
                                <input type="checkbox" name="cl_cataract_right" id="cl_cataract_right" value="1" tabindex="17">右
                                <input type="checkbox" name="cl_cataract_left" id="cl_cataract_left" value="1" tabindex="17">左
                                <input type="checkbox" name="cl_cataract_no" id="cl_cataract_no" value="1" tabindex="17">未检查
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_triglyceride" name="cl_triglyceride" size="5" tabindex="29" title="20~3000" pattern="^[0-9]{1,}$" maxlength="4" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_triglyceride') }}"> mg/dL
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clecg">
                                <input type="checkbox" name="cl_ecg" id="cl_ecg" value="1" tabindex="18">正常　异常
                                ...
                                <input type="text" id="cl_ecg_other" name="cl_ecg_other" size=10 tabindex="18" value="{{ old('cl_ecg_other') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_blood_ldl" name="cl_blood_ldl" size="5" tabindex="30" title="50~300" pattern="^[0-9]{1,}$" maxlength="3" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_blood_ldl') }}"> mg/dL
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clcoronaryheart">
                                <input type="checkbox" name="cl_coronary_heart" id="cl_coronary_heart" value="1" tabindex="19">无　　异常
                                ...
                                <input type="text" id="cl_coronary_heart_other" name="cl_coronary_heart_other" size="10" tabindex="19" value="{{ old('cl_coronary_heart_other') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_hdl" name="cl_hdl" size="5" tabindex="31" title="10~200" pattern="^[0-9]{1,}$" maxlength="3" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_hdl') }}"> mg/dL
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clstroke">
                                <input type="checkbox" name="cl_stroke" id="cl_stroke" value="1" tabindex="20">无　　异常
                                ...
                                <input type="text" id="cl_stroke_other" name="cl_stroke_other" size=10 tabindex="20" value="{{ old('cl_stroke_other') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_gpt" name="cl_gpt" size="5" tabindex="32" title="5~2000" pattern="^[0-9]{1,}$" maxlength="4" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_gpt') }}"> U/L
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clblindness">
                                <input type="checkbox" name="cl_blindness" id="cl_blindness" value="1" tabindex="21">无
                                有：<input type="checkbox" name="cl_blindness_right" id="cl_blindness_right" value="1" tabindex="21">右
                                ...
                                <input type="checkbox" name="cl_blindness_left" id="cl_blindness_left" value="1" tabindex="21">左
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_blood_creat" name="cl_blood_creat" size="5" tabindex="33" title="0.1~20" min="0.1" max="20" step="any" pattern="^[0-9]{1,}$" maxlength="2" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_blood_creat') }}"> mg/dL
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="cldialysis">
                                <input type="checkbox" name="cl_dialysis" id="cl_dialysis" value="1" tabindex="22">无
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_uricacid" name="cl_uricacid" size="5" tabindex="34" title="4~25" pattern="^[0-9]{1,}$" maxlength="2" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_uricacid') }}"> mg/dL
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clamputation">
                                <input type="checkbox" name="cl_amputation" id="cl_amputation" value="1" tabindex="23">无
                                ...
                                <input type="text" id="cl_amputation_other" name="cl_amputation_other" size=10 tabindex="23" value="{{ old('cl_amputation_other') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_urine_micro" name="cl_urine_micro" size="5" tabindex="35" title="0.1~2500" pattern="^[0-9]{1,}$" maxlength="4" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_urine_micro') }}"> mg/g
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clmedicaltreatment">
                                <input type="checkbox" name="cl_medical_treatment" id="cl_medical_treatment" value="1" tabindex="24">无
                                有：<input type="text" id="cl_medical_treatment_other" name="cl_medical_treatment_other" size=10 tabindex="24" value="{{ old('cl_medical_treatment_other') }}"> 次/月
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_upcr" name="cl_upcr" size="5" tabindex="36" title="0.1~5000" min="0.1" max="5000" step="any" pattern="^[0-9]{1,}$" maxlength="4" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_upcr') }}"> mg/g
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="cldrinking">
                                <input type="checkbox" name="cl_drinking" id="cl_drinking" value="1" tabindex="25">无
                                有：<input type="text" id="cl_drinking_other" name="cl_drinking_other" size=10 tabindex="25" value="{{ old('cl_drinking_other') }}"> c.c/周
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback" id="clsmoking">
                                <input type="radio" name="cl_smoking" id="cl_smoking" value="0" tabindex="26">无
                                <input type="radio" name="cl_smoking" id="cl_smoking" value="1" tabindex="26">有
                                <input type="text" name="cl_havesmoke" id="cl_havesmoke" size=3 tabindex="26" value="{{ old('cl_havesmoke') }}">支
                                <input type="radio" name="cl_smoking" id="cl_smoking" value="2" tabindex="26">已戒
                                <input type="text" name="cl_quitsmoke" id="cl_quitsmoke" size=10 tabindex="26" value="{{ old('cl_quitsmoke') }}">
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group has-feedback">
                                <input type="text" id="cl_egfr" name="cl_egfr" size="5" tabindex="38" title="1~500" pattern="^[0-9]{1,}$" maxlength="3" data-minlength="1" data-minlength-error="输入数字长度不足" value="{{ old('cl_egfr') }}"> ml/min/1.73m<sup>2</sup>
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </td>
