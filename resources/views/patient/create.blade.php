...
@section('content')
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            @include('errors.list')
            @if(is_null($err_msg))
            <form action="{{ route('patient.store') }}" method="POST" class="form-horizontal" role="form" data-toggle="validator">
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="pp_name" id="pp_name" class="form-control input-sm" value="{{ old('pp_name') }}" required>
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-md-10">
                        <input type="number" min="10.0" max="200.0" step="any" name="pp_height" id="pp_height" class="form-control input-sm" value="{{ old('pp_height') }}" required>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <span class="help-block with-errors"></span>
                    </div>
                </div>
                <div class="form-group has-feedback">
                    ...
                    <div class="col-md-10">
                        <input type="number" min="10.0" max="200.0" step="any" name="pp_weight" id="pp_weight" class="form-control input-sm" value="{{ old('pp_weight') }}" required>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <span class="help-block with-errors"></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10"><input type="text" name="pp_tel1" class="form-control input-sm" value="{{ old('pp_tel1') }}"></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10"><input type="text" name="pp_mobile2" class="form-control input-sm" value="{{ old('pp_mobile2') }}"></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10"><input type="text" name="pp_remark" class="form-control input-sm" value="{{ old('pp_remark') }}"></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10"><input type="text" name="pp_address" class="form-control input-sm" value="{{ old('pp_address') }}"></div>
                </div>
                <div class="form-group">
                    <label for="pp_email" class="col-md-2 control-label">电子邮件</label>
                    <div class="col-md-10">
                        <input type="email" name="pp_email" id="pp_email" class="form-control input-sm" value="{{ old('pp_email') }}">
                    </div>
                </div>
                <hr>
                <div class="form-group">
                    <label for="cc_contactor" class="col-md-2 control-label">紧急联络人</label>
                    <div class="col-md-10"><input type="text" name="cc_contactor" class="form-control input-sm" value="{{ old('cc_contactor') }}"></div>
                </div>
                <div class="form-group">
                    <label for="cc_contactor_tel" class="col-md-2 control-label">紧急联络人电话</label>
                    <div class="col-md-10"><input type="text" name="cc_contactor_tel" class="form-control input-sm" value="{{ old('cc_contactor_tel') }}"></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <label class="radio-inline"><input type="radio" value="0" name="cc_type" id="cc_type0" required>Type1</label>
                        <label class="radio-inline"><input type="radio" value="1" name="cc_type" id="cc_type1" checked>Type2</label>
                        <label class="radio-inline"><input type="radio" value="2" name="cc_type" id="cc_type2">GDM</label>
                        <label class="radio-inline"><input type="radio" value="3" name="cc_type" id="cc_type3">其他</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10"><input type="number" name="cc_ibw" id="cc_ibw" min="1.0" max="200.0" step="any" class="form-control input-sm" value="{{ old('cc_ibw') }}" placeholder="输入身高、体重后会自动计算此处"></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="number" name="cc_waist" class="input-sm" value="{{ old('cc_waist') }}" required>公分
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <span class="help-block with-errors"></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="number" name="cc_butt" class="input-sm" value="{{ old('cc_butt') }}">公分
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10"><input type="text" name="cc_wine" class="form-control input-sm" value="{{ old('cc_wine') }}"></div>
                </div>
                <div class="form-group">
                    <label for="cc_wineq" class="col-md-2 control-label">酒量c.c.</label>
                    <div class="col-md-10"><input type="number" name="cc_wineq" class="input-sm" value="{{ old('cc_wineq') }}">c.c./天
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10"><input type="text" name="cc_fh_desc" class="input-sm" value="{{ old('cc_fh_desc') }}" placeholder="备注描述">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <input type="text" name="cc_drug_allergy_name" class="input-sm" value="{{ old('cc_drug_allergy_name') }}" placeholder="对何种药物名称">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <label class="radio-inline"><input type="radio" value="0" name="cc_medicaretype" id="cc_medicaretype0" required>省医保</label>
                        ...
                        <label class="radio-inline"><input type="radio" value="4" name="cc_medicaretype" id="cc_medicaretype4">省医保公务员</label>
                        <label class="radio-inline"><input type="radio" value="5" name="cc_medicaretype" id="cc_medicaretype5">市医保公务员</label>
                        <label class="radio-inline"><input type="radio" value="6" name="cc_medicaretype" id="cc_medicaretype6">自费</label>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10" id="cccurrent">
                        <label class="radio-inline"><input type="radio" value="0" name="cc_current_use" id="cc_current0" checked required>无</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <label class="radio-inline"><input class="input-sm" type="text" name="cc_act_time" value="{{ old('cc_act_time') }}">次/周</label>
                        <label class="radio-inline">运动时间：<input class="input-sm" type="text" name="cc_act_times" value="{{ old('cc_act_times') }}">分钟/次</label>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10"><input class="form-control input-sm" type="text" name="cc_careman" value="{{ old('cc_careman') }}"></div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label" for="cc_careman_tel">照顾者电话</label>
                    <div class="col-md-10"><input class="form-control input-sm" type="text" name="cc_careman_tel" value="{{ old('cc_careman_tel') }}"></div>
                </div>
                <div class="row">
                    <label class="col-md-2 control-label" for="cc_usebsm"><span class="text-danger">*</span>使用血糖仪</label>
                    <div class="col-md-10">
                        <label class="radio-inline"><input type="radio" value="0" name="cc_usebsm" id="cc_usebsm0" checked required>无</label>
                        ...
                        <label class="radio-inline">厂牌或型号：
                            ...
                            <input class="input-sm" type="text" name="cc_otherbsm" id="cc_otherbsm" value="{{ old('cc_otherbsm') }}" placeholder="请输入新厂牌或型号">
                        </label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <label class="radio-inline">
                            <input type="radio" value="0" name="cc_usebsm_frq" id="cc_usebsm_frq0" checked required>
                            <input class="input-sm" type="text" name="cc_usebsm_frq_week" value="{{ old('cc_usebsm_frq_week') }}">次/周
                        </label>
                        <label class="radio-inline">
                            <input type="radio" value="1" name="cc_usebsm_frq" id="cc_usebsm_frq1">
                            <input class="input-sm" type="text" name="cc_usebsm_frq_month" value="{{ old('cc_usebsm_frq_month') }}">次/月
                        </label>
                    </div>
                </div>
                <div class="form-group">
