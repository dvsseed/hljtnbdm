<div class="modal fade" id="myModal{{ $hasfeature->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">

            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h5 class="modal-title" id="myModalLabel">{{-- $hasfeature->name --}}更新</h5>
            </div>
            {!! Form::model($hasfeature, ['url' => '/hasfeature/upload_hasfeature', 'class' => 'form-horizontal']) !!}
