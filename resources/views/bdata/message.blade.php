...
<div id="message" class="content" style="display: none">
    ...
    <span class="form-inline" style="position: initial; bottom: 30px; width: 100%">
        ...
        <textarea id="messagearea" class="form-control" style="height: 100px; width: 80%; margin-left: 10%"></textarea>{!! Form::button('回复', array('class'=>'btn btn-default', 'id'=>'reply', 'style' => 'margin-left: 20px')) !!}
        {!! Form::close() !!}
    </span>
