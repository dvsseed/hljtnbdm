    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
           ...
           $("#stpartdate,#etpartdate").datepicker({ picker: "<button class='calpick'></button>"});    
            ...
            $("#calendarcolor").colorselect({ title: "颜色", index: cv, hiddenid: "colorvalue" });
    ...
    <div>      
      <div class="toolBotton">           
        <a id="Savebtn" class="imgbtn" href="javascript:void(0);">                
          <span class="Save" title="保存行事历">保存(<u>S</u>)
          </span>          
        </a>                           
        <?php if(isset($event)){ ?>
        <a id="Deletebtn" class="imgbtn" href="javascript:void(0);">                    
          <span class="Delete" title="取消行事历">删除(<u>D</u>)
          </span>                
        </a>             
        <?php } ?>            
