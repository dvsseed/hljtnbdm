...
class CreateCaselistTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('caselist', function (Blueprint $table) {
            ...
            $table->decimal('cl_tc', 5, 2)->unsigned()->nullable();
            $table->decimal('cl_tg', 5, 2)->unsigned()->nullable();
            $table->decimal('cl_ldl', 5, 2)->unsigned()->nullable();
            $table->decimal('cl_hdl', 5, 2)->unsigned()->nullable();
            ...
            $table->decimal('cl_uricacid', 3, 0)->unsigned()->nullable();
