...
class CreateCaselistTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('caselist', function (Blueprint $table) {
            ...
            $table->decimal('cl_cholesterol',3,0)->unsigned()->nullable();
            $table->decimal('cl_triglyceride',4,0)->unsigned()->nullable();
            $table->decimal('cl_blood_ldl',3,0)->unsigned()->nullable();
            $table->decimal('cl_hdl',3,0)->unsigned()->nullable();
            $table->decimal('cl_gpt',4,0)->unsigned()->nullable();
            $table->decimal('cl_blood_creat',4,1)->unsigned()->nullable();
            $table->decimal('cl_uricacid',4,1)->unsigned()->nullable();
            $table->decimal('cl_urine_micro',7,2)->unsigned()->nullable();
            $table->decimal('cl_upcr',6,1)->unsigned()->nullable();
            $table->char('cl_urine_routine',3)->nullable();
            $table->decimal('cl_egfr',5,1)->unsigned()->nullable();
            $table->char('cl_foot_chk_right',6)->nullable();
            $table->char('cl_foot_chk_left',6)->nullable();
            $table->char('cl_ulcers',5)->nullable();
            ...
            $table->char('cl_ecg_item',3)->nullable();
            $table->string('cl_ecg_other',10)->nullable();
            $table->char('cl_coronary_heart',1)->nullable();
            $table->char('cl_coronary_heart_item',3)->nullable();
            $table->string('cl_coronary_heart_other',10)->nullable();
            $table->smallInteger('cl_chh_year')->unsigned()->nullable();
            $table->char('cl_chh_month',4)->nullable();
            $table->char('cl_stroke',1)->nullable();
            $table->char('cl_stroke_item',3)->nullable();
            $table->string('cl_stroke_other',10)->nullable();
            $table->smallInteger('cl_sh_year')->unsigned()->nullable();
            $table->char('cl_sh_month',4)->nullable();
            ...
            $table->smallInteger('cl_bh_year')->unsigned()->nullable();
            $table->char('cl_bh_month',4)->nullable();
            $table->char('cl_dialysis',1)->nullable();
            $table->char('cl_dialysis_item',3)->nullable();
            $table->smallInteger('cl_dh_year')->unsigned()->nullable();
            $table->char('cl_dh_month',4)->nullable();
            ...
            $table->smallInteger('cl_ah_year')->unsigned()->nullable();
            $table->char('cl_ah_month',4)->nullable();
            ...
            $table->string('cl_account',20)->nullable();
            $table->string('cl_checker',20)->nullable();
            $table->char('cl_temp',1)->nullable();
            $table->char('cl_smoking',3)->nullable();
            $table->string('cl_havesmoke',3)->nullable();
            $table->string('cl_quitsmoke',10)->nullable();
            $table->char('cl_followdiseases',6)->nullable();
            $table->timestamps();
