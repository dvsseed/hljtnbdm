...
class CreateCaselistTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('caselist', function (Blueprint $table) {
            ...
            $table->decimal('cl_tc',3,0)->unsigned()->nullable();
            $table->decimal('cl_tg',4,0)->unsigned()->nullable();
            $table->decimal('cl_ldl',3,0)->unsigned()->nullable();
            $table->decimal('cl_hdl',3,0)->unsigned()->nullable();
            $table->decimal('cl_alt',4,0)->unsigned()->nullable();
            $table->decimal('cl_ggt',4,0)->unsigned()->nullable();
            $table->decimal('cl_ua',4,1)->unsigned()->nullable();
