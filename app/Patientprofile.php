...
//    );
    ...
    public static $_source = array(
        ...
        "6" => "400网站", "7" => "朋友介绍", "8" => "网站", "9" => "其他"
    );
    // 职业
    public static $_occupation = array(
        "" => "不详", "0" => "工人", "1" => "农民", "2" => "教师", "3" => "学生", "4" => "公务员", "5" => "文职人员",
        "6" => "个体", "7" => "医生", "8" => "工程师", "9" => "会计", "10" => "司机", "11" => "建筑", "12" => "厨师", "13" => "其他"
    );
    // 语言
    public static $_language = array(
        "" => "请选择", "0" => "普通话", "1" => "美(英)语", "2" => "其他"
    );
    // 运动种类
    public static $_actkind = array(
        "" => "请选择", "0" => "散步", "1" => "快走", "2" => "广场舞", "3" => "游泳", "4" => "太极", "5" => "乒乓球",
        "6" => "羽毛球", "7" => "篮球", "8" => "足球", "9" => "自行车", "10" => "其他"
    );
